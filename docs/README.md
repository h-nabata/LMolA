...
## Runtime chemistry agents

- [Runtime chemistry-agent guidance](agents/runtime_chemistry_agent.md)
- [MCP client notes](mcp/lmola_mcp_client_notes.md)
...
- [MCP stdio client notes](mcp/lmola_mcp_client_notes.md)
- [Installation profiles](../INSTALL.md)
