...
"xtb_relax_result": dict(category="result",description="xTB relaxation result payload with optimized structure metadata.",produced_by=["smiles_to_xtb_relax","xyz_to_xtb_relax"],consumed_by=[],file_extensions=[".json"],media_types=["application/json"],required_fields=["status","geometry_modified"],semantic_tags=["xtb","relaxation","geometry_optimization"],geometry_role="relaxed_geometry",geometry_modified=True,llm_summary_hint="Relaxation result describing optimized/relaxed structure and convergence status."),
