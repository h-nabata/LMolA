...
"openbabel_conversion_report": dict(category="report",description="Open Babel conversion diagnostic report.",produced_by=["openbabel_convert_structure","smiles_to_3d_openbabel"],consumed_by=[],file_extensions=[".json",".txt"],media_types=["application/json","text/plain"],required_fields=["status"],optional_fields=["command","returncode","warnings","diagnostics"],semantic_tags=["openbabel","conversion","diagnostic"],geometry_role="non_geometry",geometry_modified=False,llm_summary_hint="Open Babel conversion diagnostics only; this is not a geometry artifact.",safety_notes=["Do not use conversion reports as primary_structure input."],compatible_input_data_types=[],notes=["Phase 17 adapter-depth artifact contract."]),
...
"molsimplify_complex_structure": dict(category="structure",description="Generated metal-complex structure produced by molSimplify.",produced_by=["molsimplify_build_metal_complex"],consumed_by=["validate_xyz","xyz_to_geometry_analysis","xyz_to_xtb_singlepoint","xyz_to_xtb_relax","xyz_to_morfeus_buried_volume","xyz_to_morfeus_cone_angle","xyz_to_morfeus_sterimol"],file_extensions=[".xyz"],media_types=["chemical/x-xyz"],required_fields=["status","geometry_modified"],optional_fields=["metal","oxidation_state","coordination_geometry","ligands"],semantic_tags=["molsimplify","metal_complex","generated","geometry"],geometry_role="generated_geometry",geometry_modified=True,llm_summary_hint="Generated molSimplify metal-complex geometry after execution; a dry-run preview is not an existing structure.",safety_notes=["Geometry artifact only after real execution produces it.","A dry-run request preview must not be used as primary_structure input."],compatible_input_data_types=["primary_structure:validation","primary_structure:geometry_analysis","primary_structure:xtb_singlepoint","primary_structure:xtb_relax","primary_structure:morfeus_steric_descriptor"],notes=["Phase 16.6 molSimplify pilot artifact contract."]),
"molsimplify_build_report": dict(category="report",description="Build report / diagnostic metadata for molSimplify generation.",produced_by=["molsimplify_build_metal_complex"],consumed_by=[],file_extensions=[".json",".txt"],media_types=["application/json","text/plain"],required_fields=["status","geometry_modified"],optional_fields=["warnings","diagnostics"],semantic_tags=["molsimplify","build_report","diagnostic"],geometry_role="non_geometry",geometry_modified=False,llm_summary_hint="molSimplify build report/diagnostics only; this is not a geometry artifact.",safety_notes=["Do not use as primary_structure input.","Build reports are not geometries."],compatible_input_data_types=[],notes=["Phase 16.6 molSimplify pilot artifact contract."]),
"molsimplify_input_deck": dict(category="input_deck",description="Reproducibility input deck or serialized request for molSimplify generation.",produced_by=["molsimplify_build_metal_complex"],consumed_by=[],file_extensions=[".json",".txt"],media_types=["application/json","text/plain"],required_fields=["status","geometry_modified"],optional_fields=["metal","ligands","coordination_geometry"],semantic_tags=["molsimplify","input_deck","reproducibility"],geometry_role="non_geometry",geometry_modified=False,llm_summary_hint="molSimplify input deck/request metadata only; this is not a geometry artifact.",safety_notes=["Do not use as primary_structure input."],compatible_input_data_types=[],notes=["Phase 16.6 molSimplify pilot artifact contract."]),
"morfeus_buried_volume_report": dict(category="report",description="Steric descriptor report generated by Morfeus for buried volume around a center atom.",produced_by=["xyz_to_morfeus_buried_volume"],consumed_by=[],file_extensions=[".json",".csv"],media_types=["application/json","text/csv"],required_fields=["status","geometry_modified"],optional_fields=["buried_volume","center_atom","center_atom_index","radius"],semantic_tags=["morfeus","steric_descriptor","buried_volume","report"],geometry_role="non_geometry",geometry_modified=False,llm_summary_hint="Morfeus buried-volume report; result/table data only and not a geometry artifact.",safety_notes=["Do not use as primary_structure input.","Can be summarized, inspected, compared, or used as tabular descriptor input only by compatible workflows."],compatible_input_data_types=[],notes=["Phase 16.5 Morfeus pilot artifact contract."]),
"morfeus_cone_angle_report": dict(category="report",description="Steric descriptor report generated by Morfeus for ligand cone angle around a center atom.",produced_by=["xyz_to_morfeus_cone_angle"],consumed_by=[],file_extensions=[".json",".csv"],media_types=["application/json","text/csv"],required_fields=["status","geometry_modified"],optional_fields=["cone_angle","center_atom","center_atom_index","ligand_atoms"],semantic_tags=["morfeus","steric_descriptor","cone_angle","report"],geometry_role="non_geometry",geometry_modified=False,llm_summary_hint="Morfeus cone-angle report; result/table data only and not a geometry artifact.",safety_notes=["Do not use as primary_structure input.","Can be summarized, inspected, compared, or used as tabular descriptor input only by compatible workflows."],compatible_input_data_types=[],notes=["Phase 16.5 Morfeus pilot artifact contract."]),
"morfeus_sterimol_report": dict(category="report",description="Steric descriptor report generated by Morfeus for Sterimol parameters along an atom-defined axis.",produced_by=["xyz_to_morfeus_sterimol"],consumed_by=[],file_extensions=[".json",".csv"],media_types=["application/json","text/csv"],required_fields=["status","geometry_modified"],optional_fields=["sterimol","atom1","atom2","substituent_atoms"],semantic_tags=["morfeus","steric_descriptor","sterimol","report"],geometry_role="non_geometry",geometry_modified=False,llm_summary_hint="Morfeus Sterimol report; result/table data only and not a geometry artifact.",safety_notes=["Do not use as primary_structure input.","Can be summarized, inspected, compared, or used as tabular descriptor input only by compatible workflows."],compatible_input_data_types=[],notes=["Phase 16.5 Morfeus pilot artifact contract."]),
}
