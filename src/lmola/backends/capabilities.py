...
_BASE: dict[str, BackendCapability] = {
    ...
    "morfeus": BackendCapability(backend_id="morfeus", display_name="Morfeus", category="descriptor", integration_type="python_import", optional_extra=None, python_modules=["morfeus"], required_for=["xyz_to_morfeus_buried_volume", "xyz_to_morfeus_cone_angle", "xyz_to_morfeus_sterimol"], supported_input_types=["xyz"], supported_output_types=["descriptor_report_json"], supported_tasks=["steric_descriptor_calculation"], execution_modes=["in_process"], safety_notes=["Optional descriptor backend; absent installations must be reported as unavailable."]),
