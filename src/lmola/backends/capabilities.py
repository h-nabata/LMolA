...
_BASE: dict[str, BackendCapability] = {
    "ase": BackendCapability(backend_id="ase", display_name="Atomic Simulation Environment", category="validation", integration_type="python_import", python_modules=["ase"], required_for=["validate_xyz"], supported_input_types=["xyz", "xyz_list", "smiles", "smiles_csv"], supported_output_types=["validation_report_json"], supported_tasks=["validation", "structure_io"], execution_modes=["in_process"], safety_notes=["Read-only geometry validation by default."]),
    "rdkit": BackendCapability(backend_id="rdkit", display_name="RDKit", category="structure_generation", integration_type="python_import", optional_extra="rdkit", python_modules=["rdkit"], required_for=["smiles_to_3d_rdkit", "smiles_to_conformers_rdkit", "smiles_to_xtb_relax"], supported_input_types=["smiles", "smiles_csv"], supported_output_types=["xyz", "sdf", "conformer_ensemble"], supported_tasks=["structure_generation", "conformer_generation"], execution_modes=["in_process"]),
    ...
    "xtb": BackendCapability(backend_id="xtb", display_name="xTB", category="relaxation", integration_type="hybrid", python_modules=["xtb"], executables=["xtb"], required_for=["smiles_to_xtb_relax", "xyz_to_xtb_relax"], supported_input_types=["xyz", "xyz_list", "smiles", "smiles_csv"], supported_output_types=["relaxed_xyz", "energy"], supported_tasks=["relaxation"], execution_modes=["cli"]),
    "molsimplify": BackendCapability(backend_id="molsimplify", display_name="molSimplify", category="structure_generation", integration_type="hybrid", optional_extra="molsimplify", python_modules=["molSimplify"], executables=["molsimplify"], supported_input_types=["text"], supported_output_types=["xyz"], supported_tasks=["metal_complex_generation"], execution_modes=["cli", "in_process"]),
