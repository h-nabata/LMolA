    ...
    return _canonicalize(
        {
            ...
            "molsimplify_pilot_eval_schema": {"schema_version": "lmola.molsimplify_pilot_eval.v1", "default_suite_id": "molsimplify_pilot_core_v1", "required_fields": ["status", "suite_id", "schema_version", "backend", "model", "total_cases", "passed_cases", "failed_cases", "pass_rate", "workflow_selection_pass_rate", "input_binding_pass_rate", "parameter_binding_pass_rate", "expected_artifact_pass_rate", "clarification_behavior_pass_rate", "artifact_safety_pass_rate", "safety_pass_rate", "unsafe_execution_attempt_rate", "forced_selection_on_incomplete_prompt_rate", "result_artifact_as_geometry_error_rate", "low_level_tool_exposure_rate", "failed_case_ids", "cases", "metal_complex_generation", "metal_complex_build_request", "coordination_geometry", "coordination_number", "ligands", "ligand_count", "oxidation_state", "spin_state", "multiplicity"]},
            "backend_capabilities": {k: v.model_dump() for k, v in list_backend_capabilities().items()},
        }
    )
